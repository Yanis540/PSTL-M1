...
./ted.exe file input-data/trees/1.bracket input-data/trees/2.bracket 
./ted.exe file input-data/trees/1.bracket input-data/trees/2.bracket  > results/trees/1-2.txt # save in the file 


echo "Experiment for trees 1 and 3"
./ted.exe file input-data/trees/1.bracket input-data/trees/3.bracket 
./ted.exe file input-data/trees/1.bracket input-data/trees/3.bracket  > results/trees/1-3.txt # save in the file 


echo "Experiment for trees 2 and 3"
./ted.exe file input-data/trees/2.bracket input-data/trees/3.bracket 
./ted.exe file input-data/trees/2.bracket input-data/trees/3.bracket  > results/trees/2-3.txt # save in the file 
